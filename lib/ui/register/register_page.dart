...
import 'package:flutter/services.dart'; // Dodaj ten import
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _sendVerificationEmail(User user) async {
    try {
      ...
      _showError('Nie udało się wysłać e-maila weryfikacyjnego: ${e.message}');
    }
  }
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        _showError('Zarejestrowano! Sprawdź swoją skrzynkę pocztową, aby zweryfikować adres e-mail.');
      } else {
